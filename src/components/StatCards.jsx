  ...
  const cards = [
    {
      ...
      bg: 'bg-blue-400',
      pattern: `${import.meta.env.BASE_URL}images/pattern-character-count.svg`,
    ...
    },
    {
      ...
      label: 'Word Count',
      bg: 'bg-yellow-500',
      pattern: `${import.meta.env.BASE_URL}images/pattern-word-count.svg`,
    ...
    },
    {
      ...
      bg: 'bg-orange-500',
      pattern: `${import.meta.env.BASE_URL}images/pattern-sentence-count.svg`,
